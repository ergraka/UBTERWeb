<%@ Page Title="Open Reports" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true"
    CodeFile="Openreports.aspx.cs" Inherits="Openreports" %>
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                <p class="panel-heading" style="background-image: url(../Images/bg.jpg); font-family: Agency FB;
                                    ...
                                    <asp:Label ID="Lblcp" runat="server" Text=" -- Add Institute & Barch Category For Report --"></asp:Label>
                                </p>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <asp:DropDownList ID="Drpsearchtype" ValidationGroup="Reg" CssClass="Fontfill" AutoPostBack="true"
                                            runat="server" OnSelectedIndexChanged="Drpsearchtype_SelectedIndexChanged">
                            ...
                            <td>
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <asp:CompareValidator ID="RFVDrpsearchtype" runat="server" Display="None" ValidationGroup="Reg"
                                            ErrorMessage="Please Select Search Type." ControlToValidate="Drpsearchtype" ValueToCompare="0"
