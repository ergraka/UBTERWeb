                            ...
                            <tr>
                                <td align="center" colspan="2">
                                    <p class="panel-heading" style="background-image: url(../Images/bg.jpg); font-family: Agency FB; font-size: 25px; color: #FFFFFF;">
                                        <asp:Label ID="Lblcp" runat="server" Text=" -- Student Login --"></asp:Label>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <asp:TextBox ID="txtUserName" onkeypress="return numbersonly(event)" runat="server"
                                                CssClass="Fontfill" ValidationGroup="Login" AutoComplete="off" MaxLength="11"
                                                ToolTip="Registration Number OR Roll Number" placeholder="Registration Number OR Roll Number"></asp:TextBox>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password" AutoComplete="off" onkeypress="return Password(event)"
