<%@ Page Title="" Language="C#" MasterPageFile="~/Student/Home.master" AutoEventWireup="true"
    CodeFile="Scrutiny.aspx.cs" Inherits="Scrutiny" %>
                ...
                <table width="1024px" align="center" style="border: solid 1px #000000; color: #000000;
                    ...
                    <tr>
                        <td align="center">
                            ...
                            &nbsp;&nbsp;&nbsp;
                            <asp:Image ID="Imgscru" runat="server" Visible="true" Height="25px" Width="20px"
                                ImageUrl="~/Images/rightarrow.gif" />
                            <a id="Lnkscrureceipt" runat="server" class="Link" href="~/Report/Receiptscrutiny.aspx" target="_blank">
                                Print Scrutiny Receipt</a>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="left" style="font-family: Cambria; font-size: 14px; color: #0000FF;
                            ...
                            <b><u>NOTE :</u> </b>
                            <br />
                            01 :- SCRUTINY FORM FEE PER SUBJECT INR : 250/-<br />
