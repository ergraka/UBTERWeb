...
public partial class ChangePassword : System.Web.UI.Page
{
    ...
    private void _sendMail()
    {
        ...
        try
        {
            ...
            objmsg.Subject = "Change Password For-" + Session["ID"].ToString();
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
                ...
                string _sqlQuery = "update REGISTRATION set PASSWORD='" + Txtnpassword.Text.Trim() + "' where PASSWORD='" + Txtpassword.Text.Trim() + "' and CANDIDATEID='" + Session["ID"].ToString().Trim() + "'";
                ...
                if (result == "1-1")
                {
                    ...
                    string _sqlQuery1 = "select * from REGISTRATION where CANDIDATEID='" + Session["ID"].ToString() + "'";
                    AllQueryParam[0] = _sqlQuery1;
                    BLL objbllLogin = new BLL();
                    objbllLogin.QUERYBLL(ref dt, AllQueryParam);
                    if (dt.Rows.Count > 0)
                    {
                        _name = dt.Rows[0]["CNAME"].ToString();
