<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sessional_Marks.aspx.cs"
    Inherits="Sessional_Marks" %>
                                ...
                                <asp:GridView ID="Grddata" CssClass="grd" AllowPaging="True" Width="100%" runat="server"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="MARKS" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:TextBox ID="Txtmarks" MaxLength="3" Font-Names="Cambria" Width="50px" onkeypress="return numbersonly(event)"
