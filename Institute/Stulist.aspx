<%@ Page Title="Student List" Language="C#" MasterPageFile="~/Institute/Default.master"
    AutoEventWireup="true" CodeFile="Stulist.aspx.cs" Inherits="Stulist" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <table width="1024px" align="center" style="margin: 0px; font-family: Cambria;">
                    ...
                    <tr>
                        <td align="left">
                            CLICK ON NAME TO VIEW OR PRINT DETAIL'S.
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="3">
                            <asp:GridView ID="Grddata" CssClass="grd" Width="100%" runat="server" AllowPaging="false"
                                PagerSettings-Mode="Numeric" Font-Size="15px" AllowSorting="True" AutoGenerateColumns="False"
                                CellPadding="3" OnPageIndexChanging="Grddata_PageIndexChanging" BackColor="White"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField HeaderText="ROLL" DataField="ROLL" HeaderStyle-HorizontalAlign="center"
                    ...
                    <tr>
                        <td align="right">
                            ...
                            <asp:GridView ID="Grdaproved" CssClass="grd" Width="100%" runat="server" AutoGenerateColumns="False"
                                OnPageIndexChanging="Grdapro_PageIndexChanging" CellPadding="3" BackColor="White"
                                DataKeyNames="CANDIDATEID" OnRowDeleting="OnRowDeleting" BorderColor="#CCCCCC"
                                ...
                                <Columns>
                                    ...
                                    <asp:CommandField ShowDeleteButton="true" ControlStyle-CssClass="grd" ControlStyle-BackColor="#FFFFFF" ItemStyle-ForeColor="#FF0000"
                                        ButtonType="Link">
                                    </asp:CommandField>
                                    <asp:TemplateField HeaderText="APPROVE/DISAPPROVE" HeaderStyle-HorizontalAlign="center" ItemStyle-HorizontalAlign="center">
                                        <HeaderStyle HorizontalAlign="center"></HeaderStyle>
                                        <ItemTemplate>
