<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Nominalsbackpaper.aspx.cs"
    Inherits="Nominalsbackpaper" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Special Back Paper Nominal Roll</title>
            ...
            <table style="width: 100%;">
                <tr>
                    <th colspan="2" align="center" style="font-family: Cambria; border-bottom: 1px solid #000000;
                        ...
                        ( SPECIAL BACK PAPER NOMINAL ROLL )<br />
                        <%=CP %>
                        <br />
                        <br />
                    </th>
