<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receiptreeva.aspx.cs" Inherits="Receiptreeva" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Re-Evalutaion Receipt</title>
    ...
    <center>
        ...
        <div style="width: 90%;">
            ...
            <table class="table">
                ...
                <tr>
                    <td align="justify" colspan="4" valign="middle" style="border-bottom: 1px solid #000000;">
                        <br />
